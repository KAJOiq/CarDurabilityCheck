...
import SearchModalForPrinterUser from "./SearchModalForPrinterUser";
import CarForm from "./CarForm";
import TruckForm from "./TruckForm";
import BikeForm from "./BikeForm";

const ShowFormsForPrinter = () => {
  const [isSearchModalForPrinterUserOpen, setIsSearchModalForPrinterUserOpen] = useState(false);
    ...
    <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl p-8 transition-all duration-300 hover:shadow-3xl">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:justify-center mb-8">
        <button
          ...
          onClick={() => setIsSearchModalForPrinterUserOpen(true)}
        >
      ...
      <SearchModalForPrinterUser
        isOpen={isSearchModalForPrinterUserOpen}
        onClose={() => setIsSearchModalForPrinterUserOpen(false)}
...
export default ShowFormsForPrinter;
