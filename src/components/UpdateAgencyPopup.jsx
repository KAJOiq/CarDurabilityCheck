...
const UpdateAgencyPopup = ({ onClose, refreshData, agencyId, agencyName: initialAgencyName }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetchData(
        `admin/lookup/update-traffic-agencies?Id=${agencyId}&NewName=${encodeURIComponent(agencyName)}`,
        {
          method: "PUT",
          headers: {
            "accept": "*/*",
...
export default UpdateAgencyPopup;