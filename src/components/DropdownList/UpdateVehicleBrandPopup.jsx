...
const UpdateVehicleBrandPopup = ({ onClose, refreshData, brandId, brandName: initialBrandName }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetchData(
                `admin/lookup/update-vehicle-company?Id=${brandId}&NewName=${encodeURIComponent(brandName)}`,
                {
                    method: "PUT",
                    headers: {
                        "accept": "*/*",
            ...
            if (response.isSuccess) {
                setSuccess("تم تعديل العلامة التجارية بنجاح!");
                refreshData(); 
                setTimeout(() => {
                    onClose(); 
                }, 1000);
            ...
            <div className="bg-white rounded-xl shadow-lg w-full max-w-md overflow-hidden">
                <div className="p-6">
                    <h3 className="text-xl font-semibold text-gray-800 mb-4">
                        ...
                        تعديل الماركة التجارية للمركبة
                    </h3>
                    ...
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-gray-700 mb-1">اسم الماركة التجارية</label>
                        <input
                            type="text"
                            value={brandName}
...
export default UpdateVehicleBrandPopup;